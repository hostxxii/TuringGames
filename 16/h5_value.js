// --- BOM/DOM 模拟环境补充 (v3 - Fix abort Error) ---

// 全局 window 对象 (脚本已将 global 赋值给 window)
var window = global; // 或者直接使用 global，但明确定义更清晰
...
window.document = {
    ...
    createElement: function(tagName) {
        ...
        const element = {
            style: {},
            appendChild: function(child) { /* console.log('element.appendChild called'); */ },
            removeChild: function(child) { /* console.log('element.removeChild called'); */ },
            ...
            getContext: function(contextId) {
                 if (tagName.toLowerCase() === 'canvas' && (contextId === '2d' || contextId.includes('webgl'))) {
                    return { // 模拟上下文省略
                         fillStyle: '', strokeStyle: '', lineWidth: 0, lineCap: '', shadowOffsetX: 0, shadowOffsetY: 0, shadowColor: '', font: '', textBaseline: '',
                         fillRect: function() {}, arc: function() {}, stroke: function() {}, fillText: function() {},
                         getParameter: function(param) { const params = { 37445: 'WebGL GLSL ES_1.00', 37446: 'WebGL 1.0 (OpenGL ES 2.0 Chromium)', 7937: 'WebKit WebGL', 7936: 'WebKit', 7938: 'WebGL 1.0', 3410: 2, 34921: 8, 34930: 16, 3379: 8192, 34024: 8192, 34047: 8, 34076: 16, 34018: 8192, 34852: 8, 33901: [1, 1024], 33902: [1, 1024], 3413: 8, 3412: 8, 3411: 8, 3410: 8, 3414: 24, 3415: 8, 3386: [8192, 8192] }; return params[param] || null; },
                         getExtension: function(extName) { if (extName === 'WEBGL_debug_renderer_info') { return { UNMASKED_VENDOR_WEBGL: 37445, UNMASKED_RENDERER_WEBGL: 37446 }; } return null; },
                         createBuffer: function() { return { /* buffer mock */ }; }, bindBuffer: function() {}, bufferData: function() {}, createProgram: function() { return { /* program mock */ }; }, createShader: function() { return { /* shader mock */ }; }, shaderSource: function() {}, compileShader: function() {}, attachShader: function() {}, linkProgram: function() {}, useProgram: function() {}, getAttribLocation: function() { return 0; }, getUniformLocation: function() { return {}; }, enableVertexAttribArray: function() {}, vertexAttribPointer: function() {}, uniform2f: function() {}, drawArrays: function() {}, clearColor: function() {}, enable: function() {}, depthFunc: function() {}, clear: function() {}, getContextAttributes: function() { return { antialias: true }; },
                         getSupportedExtensions: function() { return ["ANGLE_instanced_arrays", "EXT_blend_minmax", "EXT_color_buffer_half_float", "EXT_disjoint_timer_query", "EXT_float_blend", "EXT_frag_depth", "EXT_shader_texture_lod", "EXT_texture_compression_rgtc", "EXT_texture_filter_anisotropic", "EXT_sRGB", "OES_element_index_uint", "OES_fbo_render_mipmap", "OES_standard_derivatives", "OES_texture_float", "OES_texture_float_linear", "OES_texture_half_float", "OES_texture_half_float_linear", "OES_vertex_array_object", "WEBGL_color_buffer_float", "WEBGL_compressed_texture_s3tc", "WEBGL_compressed_texture_s3tc_srgb", "WEBGL_debug_renderer_info", "WEBGL_debug_shaders", "WEBGL_depth_texture", "WEBGL_draw_buffers", "WEBGL_lose_context", "WEBKIT_EXT_texture_filter_anisotropic", "WEBKIT_WEBGL_compressed_texture_s3tc", "WEBKIT_WEBGL_depth_texture", "WEBKIT_WEBGL_lose_context"]; }
                     };
                 }
                 return null;
            }
        };
        element.parentNode = window.document;
        return element;
    },
    body: {
         appendChild: function(child) { /* console.log('document.body.appendChild called'); */ },
         removeChild: function(child) { console.log('document.body.removeChild called'); }
    },
    ...
    removeChild: function(child) {
        console.log('document.removeChild called');
        return child;
    }
};
...
window.btoa = typeof btoa === 'function' ? btoa : function(str) { return Buffer.from(str, 'binary').toString('base64'); };
window.atob = typeof atob === 'function' ? atob : function(str) { return Buffer.from(str, 'base64').toString('binary'); };
...
window.XMLHttpRequest = class MockXMLHttpRequest {
    ...
    abort() {
        ...
        // 可以选择性地模拟状态变化
        this.readyState = 0; // 或者 4?
        this.status = 0;
        // 如果需要，触发 onreadystatechange
...
window.localStorage = (function() { let store = {}; return { getItem: function(key) { return store[key] || null; }, setItem: function(key, value) { store[key] = String(value); }, removeItem: function(key) { delete store[key]; }, clear: function() { store = {}; }, key: function(index) { const keys = Object.keys(store); return keys[index] || null; }, get length() { return Object.keys(store).length; } }; })();
window.sessionStorage = (function() { let store = {}; return { getItem: function(key) { return store[key] || null; }, setItem: function(key, value) { store[key] = String(value); }, removeItem: function(key) { delete store[key]; }, clear: function() { store = {}; }, key: function(index) { const keys = Object.keys(store); return keys[index] || null; }, get length() { return Object.keys(store).length; } }; })();
...
window.CustomEvent = class CustomEvent extends window.Event { constructor(type, detail) { super(type); this.detail = detail; } };
window.MouseEvent = class MouseEvent extends window.Event {};

// process 对象
if (typeof process === 'undefined') {
   window.process = { env: {}, versions: { node: '16.0.0' }, nextTick: function(callback) { setTimeout(callback, 0); }, domain: null, emit: function() {} };
} else {
   if (!window.process.emit) window.process.emit = function() {};
   if (!window.process.domain) window.process.domain = null;
}
...
function get_h5(p) {
  ...
  a= PcSign._$sdnmd(ss)['h5st'];
  b= PcSign._$sdnmd(ss)['t'];
  return [btoa(a + String(b)),b];
}
console.log(get_h5(1))
