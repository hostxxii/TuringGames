...
cookies = {
    ...
    'Hm_lpvt_b5d072258d61ab3cd6a9d485aac7f183': '1746166721',
}
...
for page in range(1,21):
    ...
    response = requests.get('https://www.mashangpa.com/api/problem-detail/12/data/', params=params, cookies=cookies, headers=headers)
